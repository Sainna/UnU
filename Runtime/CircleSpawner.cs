...
{
    [SerializeField]
    GameObject _ToSpawn = null;

    [SerializeField]
    Transform _LookTransform = null;
    ...
    public void SpawnItems()
    {
        ...
        {
            Vector3 spawnPosition = new Vector3(_Radius * Mathf.Cos(currentAngle + (_Behind ? Mathf.PI : 0)), 0, _Radius * Mathf.Sin(currentAngle+ (_Behind ? Mathf.PI : 0)));
